...
public:
	...
	void RenderLeftWall();
	void RenderPicture();
	void RenderFlowerPot();
	void RenderTreeTrunk();
	void RenderTreeLeaves();
	void RenderCouchBase1();
	void RenderCouchBase2();
	void RenderCouchRightLeg();
	void RenderCouchBack();
	void RenderCouchLeftLeg();
	void RenderCouchBackRightLeg();
	void RenderCouchBackLeftLeg();
	void RenderCouchLeftArm();
	void RenderCouchRightArm();
	void RenderCouchLeftCusion();
	void RenderCouchRightCusion();
	void RenderCouchLeftBackCusion();
	void RenderCouchRightBackCusion();
	void RenderCouchRightCusion1();
	void RenderCouchRightCusion2();
	void RenderCouchLeftCusion1();
	void RenderCouchLeftCusion2();
	void RenderCouchLeftCusion3();
	void RenderTableTop();
	void RenderTableleg1();
	void RenderTableleg2();
	void RenderTableleg3();
};